  ...
  return (
    <>
      <main className="bg-gray-900 overflow-x-hidden">
        <div className="c2 bg-gray-900 absolute top-11/12 flex flex-col w-screen h-screen">
        ...
        <div className="c3 w-screen h-96 flex flex-col gap-6">
          <div className="profits  w-screen h-40 bg-transparent flex justify-center gap-3 flex-row">
            ...
            <div className="flex flex-col justify-center">
              <strong className="text-white text-3xl self-center">
                First Income
              </strong>
